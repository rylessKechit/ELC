...
const BookingForm = () => {
  ...
  const calculateTotalPrice = async () => {
    ...
    try {
      ...
      // Si le calcul a réussi, masquer le formulaire pour afficher uniquement le calculateur de prix
      if (priceEstimate) {
        setShowForm(false);
      }
    } catch (err) {
  ...
  return (
    <div className="booking-form-container luxury-card">
      <h2 className="form-title">Réservation Premium</h2>
          ...
          >
            <motion.div className="form-group" variants={itemVariants}>
              <AddressInput 
                ...
                placeholder="Saisissez votre adresse de prise en charge"
            ...
            <motion.div className="form-group" variants={itemVariants}>
              <AddressInput 
                ...
                placeholder="Saisissez votre adresse de destination"
            ...
            <motion.div className="form-row" variants={itemVariants}>
              <div className="form-group">
                ...
                <motion.select 
                  ...
                  whileHover={{ boxShadow: '0 0 8px rgba(212, 175, 55, 0.3)' }}
            ...
            <motion.div className="form-group checkbox" variants={itemVariants}>
              <label className="custom-checkbox">
                ...
                <span className="checkbox-label">Aller-retour</span>
              </label>
            </motion.div>
            ...
            <AnimatePresence>
              {formData.roundTrip && (
                <motion.div 
                  className="form-row return-trip-row"
            ...
            <motion.button 
              ...
              whileHover={{ 
                ...
                boxShadow: loading ? 'none' : '0 0 15px rgba(212, 175, 55, 0.4)'
              }}
